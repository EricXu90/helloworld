...
def with_pdf (pdf_doc, fn, pdf_pwd, *args):
    ...
    try:
        ...
        parser = PDFParser(fp)
        # create a PDFDocument object that stores the document structure and supply the password for initialization
    ...
    for lt_obj in lt_objs:
        if isinstance(lt_obj, LTTextBox) or isinstance(lt_obj, LTTextLine):
            ...
            if saved_file:
                ...
                pass # print >> sys.stderr, "error saving image on page", page_number, lt_obj.__repr__
...
def get_pages (pdf_doc, pdf_pwd='', images_folder='C:\\TEMP'):
...
if __name__ == '__main__':
    pdf_file = r'c:\DailyReport.pdf'
    #txt = get_pages(pdf_doc=pdf_file)
    #print txt
    table = get_toc(pdf_file)
